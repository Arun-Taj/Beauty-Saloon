    ...
    <div className="container-custom grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="font-serif text-xl text-white">Soniya Beauty</span>
        </div>
      ...
      <div>
        ...
        <div className="space-y-3 text-sm text-cream-300">
          <div className="flex items-center gap-3"><MapPin size={14} className="text-gold-400 shrink-0" /><span>Damak, Jhapa, Nepal</span></div>
          <div className="flex items-center gap-3"><Phone size={14} className="text-gold-400" /><span>9814999911</span></div>
          <div className="flex items-center gap-3"><Mail size={14} className="text-gold-400" /><span>hello@soniyabeauty.com</span></div>
        </div>
      </div>

    </div>
    <div className="border-t border-cream-300/10 pt-8 text-center text-xs text-cream-300/50 font-sans">
      © {new Date().getFullYear()} Soniya Beauty Salon. All rights reserved.
    </div>
  </footer>
);
